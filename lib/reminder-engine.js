...
export class ReminderEngine {
  ...
  /**
   * Build the round-robin pool from the active category config and the
   ...
   * added/removed activities are exactly what gets suggested.
   */
  _buildPool() {
  ...
  /**
   * Pick the next unsuggested activity id round-robin. Returns null when
   * the whole pool has been suggested.
   * @returns {Object|null}
   */
  _nextSuggestion() {
